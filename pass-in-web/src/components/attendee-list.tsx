            ...
            <div className="flex gap-3 items-center">
                ...
                <div className="px-3 py-1.5 w-72 border border-white/10 rounded-lg text-sm flex items-center gap-3">
                    ...
                    <input onChange={onSearchInputChanged}
                        value={searchInput}
                        className="bg-transparent flex-1 outline-none border-0 p-0 text-sm focus:ring-0" placeholder="Buscar participante..."
                    />
                </div>
            </div>
            ...
            <Table>
                    <thead>
                        <tr className='border-b border-white/10'>
                            ...
                            <TableHeader>Data do check-int</TableHeader>
